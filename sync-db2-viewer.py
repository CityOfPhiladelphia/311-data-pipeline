...
def main(prod):
    ...
    try:
        ...
        # ONLY the rows that are missing based off the requested_datetime column
        ...
        WHERE rawview.requested_datetime > (
            SELECT COALESCE(MAX(requested_datetime), '1970-01-01')
